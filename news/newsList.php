...
for($j=$startItem;$j<$startItem+$itemAmount;$j++)
{
	...
	echo "<div id='mScrsht'><a href='?cnt=iinfo&category=".$category."&newsn=".$item."&itemid=".$itemid."&l=".$lg."'>";
	//include($rootPath."category/".$category."/".$item."/mScrnsht_".$item.".php");
	echo "</a></div>";
	// End Main Screenshot
	echo "</td><td>";
	echo "<div id='appWinName'> <a href='?cnt=iinfo&category=".$category."&newsn=".$item."&itemid=".$itemid."&l=".$lg."'><h2>".$item."</h2></a></div><br/>";
	...
	echo "<br/>";
	echo "<a href='?cnt=iinfo&category=".$category."&newsn=".$item."&itemid=".$itemid."&l=".$lg."'><b>".$more_lg."...</b></a>";
	echo "</td></tr></table>";
	echo "</div>";
		echo "<hr>";
